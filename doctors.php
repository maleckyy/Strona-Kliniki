...
<br>
  <div class="form">
    ...
    <form action="adddoctor.php" method="post">
      ...
      <div class="form-group">
        <input type="text" class="form-control" placeholder="specialization" value="" name="specialization"/>
      </div>
      <div class="form-group">
        <input class="button" id="button" type="submit" value="Add Doctor" name="submit"/>
      </div>
    </form>
  </div>
